...
export default function DragDropImageUploader({ onImageUpload, isLoading }: DragDropImageUploaderProps) {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`relative border-3 border-dashed rounded-lg p-4 text-center transition-all cursor-pointer ${dragActive
        ...
        <div className="flex flex-col items-center gap-2">
          {uploading ? (
            <>
              ...
              <p className="font-semibold text-xs text-[var(--brand-purple)]">Uploading...</p>
            </>
          ) : (
            <>
              ...
              <div>
                <p className="font-bold text-[var(--brand-purple)] text-sm">Drop cover image or click</p>
